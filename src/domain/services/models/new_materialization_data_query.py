def getRowCountQuery(db: str, tableSchema: str, tableName: str, materializationType: str):
...
def getColumnCountQuery(db: str, tableName: str):
  return f"""select count(column_name) from {db}.information_schema.columns
  where table_name = {tableName};
  """

def getFreshnessQuery(db: str, tableSchema: str, tableName: str, materializationType: str):
